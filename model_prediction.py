...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('./data/test_model.pth', map_location=torch.device('cpu')))
    ...
    pd.DataFrame(output.numpy(), columns=['result']).to_csv("./predicted_result.csv")
    print("Successful")